...
{
	/**
	 * Initialize the layout panels and components
	 */
	 ...
	 * UPDATED TO REDUCE LENGTH AND COMPLEXITY
	 */
	...
	private void initComponents() {
		...
		// Initialize components and configure layout
		initSplitPane();
		initGraphPanel();
		initTablePanel();
		configureMainLayout();
	...
	/**
	 * Initializes the SplitPane component
	 */
	private void initSplitPane() {
		// Initialize JSplitPane and set properties
		...
		jSplitPane1.setName("splitter");
		jSplitPane1.setOneTouchExpandable(true);
	}

	/**
	 * Initializes the Graph Panel Component
	 */
	private void initGraphPanel() {
		// Initialize graph panel and related components
	...
	/**
	 * Initializes the Slider Panel Component
	 */
	private void initSliderPanel() {
		// Initialize slider panel and related components
		...
		slGraphTime.addChangeListener(evt -> slGraphTimeStateChanged());
	...
	/**
	 * Initializes the clear history button component
	 */
	private void initClearHistoryButton() {
		...
		btnClearHist.addActionListener(evt -> btnClearHistActionPerformed());
	}

	/**
	 * Initializes the table panel component
	 */
	private void initTablePanel() {
		// Initialize table panel and related components
	...
	/**
	 * Configures the main layout of the component
	 */
	private void configureMainLayout() {
		// Configure main layout of the component
		setFont(new java.awt.Font("Dialog", 0, 10));
		setName("DataPanel");
		setLayout(new java.awt.BorderLayout());
		add(jSplitPane1, java.awt.BorderLayout.CENTER);
	}// </editor-fold>//GEN-END:initComponentslPane jScrollPane1 = new javax.swing.JScrollPane();
